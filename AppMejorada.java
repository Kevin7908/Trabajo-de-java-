...
public class AppMejorada {
    ...
    public static void menu() {
        ...
        while (continuar) {
            ...
            int opc = t.nextInt();
            // Creo un swtch para la evaluación de la opción ingresada por el usuario en
            // este caso opc.
            switch (opc) {
                ...
                case 1:
                    ...
                    */
                    ...
                    // Creacion de un if para que dependiendo de la opcion entre y pida unos datos
                    // extras
                    ...
                    if (agregar == 1) {
                        ...
                        // Llamo la instancia de GestionarEquipos y la funcion mostrar quelo que hace es
                        // mostrar
                        ...
                        // En esta linea utilizo un operador terneario para decidir si la variable va a
                        // tener
                ...
                case 4:
                    ...
                    // Los datos los voy enviar a una funcion de GestionarEquipos llamada repetido
                    // la cual
                    // va a mirar si en la lista que tenemos los datos que enviarios osea si hay ese
                    // numero
                    ...
                    if (repe == true) {
                        ...
                        System.out.println("Ingrese el nombre del equipo del jugador a borrar: ");
                        // creo que esto ya sabes que es, creamos una variable de tipo NombreEquipo y
                        // mostramos
                        ...
                        gestionar.modificarEquipos(numeroJugadorModificar, nombreEquipitoModificarString, nuevoNum,
                                nuevoEquiString);
                    } else {
    ...
    public static int mostrarOpcionStream() {
        ...
        System.out.println("De este menu entonces no podra filtrar ");
        System.out.println();
        System.out.println("Ingrese que desea ver: ");
        System.out.println("1. Generar un equipo aleatoriamente con Supplier");
        System.out.println("2. Simulacion de una partido con Supplier");
        System.out.println("3. Filtrar por inicial de equipo de la base de datos secundaria");
