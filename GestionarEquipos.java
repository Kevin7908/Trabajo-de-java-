...
public class GestionarEquipos {
    ...
    // Esta funcion recibe una clase seguido de eso nos damos cuenta de que se esta
    // iterando sobre ella
    // para ver si hay un equipo y numero de jugador repetido si esa asi entoces se
    // retorna para que deje de
    ...
    // esta fincion recibe el nombre de equipo a modificar y el numero jugador,
    // tambien el equipo y numero nuevo
    // itera sobre el arraylist llamado equipos, y en el if si el equipo que
    // enviamos es igual al que se esta
    // iterado en ese momento y el numero de jugador tambien entonces entra
    ...
    /**
     * Elimina un equipo de fútbol de la lista de equipos según el número de jugador
     * y el nombre del equipo proporcionados.
     *
    ...
    public void eliminarEquipos(int numju, String equi) {
        ...
        while (iterator.hasNext()) {
            ...
            // Se verifica si el número de jugador y el nombre del equipo coinciden con los
            // proporcionados.
    ...
    /**
     * Muestra la información de un equipo de fútbol específico que coincide con el
     * número de jugador y el nombre del equipo dados.
     *
     * parametro numJu, El número de jugador del equipo que se desea mostrar.
     * parametro nomEqui, El nombre del equipo al que pertenece el jugador que se
     * desea mostrar.
     */
    public void mostrarEquipoEspecifico(int numJu, String nomEqui) {
        // Itera sobre la lista de equipos de fútbol
        for (EquipoFutbol e : equipos) {
            // Comprueba si el nombre del equipo y el número de jugador coinciden con los
            // proporcionados
    ...
    // para empezar notamos que le llega la clase EquipoGenerico pero esta trae
    // consigo un comodin que extiende
    // de EquipoFutbol, ademas recibe una variable booleana b
    // pregunta si b == true, y aca nos devolvenos a equipo generico para ser mas
    // especifico agregarEquipoGnerico
    // la cual nos retornaba false si el jugador estaba repetido
    // entonces si el jugador no esta repetido me retorna true y entra en el if, aca
    // le decimos que al arralist
    // de la clase gestionar le agregue equipo generico, y lo que hace la funcion
    // obtenerListaEquipo es retornarme
    // el arraylist de equipogenerico con los datos que ingrese si no me muestra un
    // mensaje
    ...
    // en el if si cumple con la condicion de que si el nombre que le enviamos es
    // igual al que esta en ese
    // momento es igual y el numero tambien, entonces entra y nos retorna true, si
    // no false
